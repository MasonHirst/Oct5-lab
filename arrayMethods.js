...
// CODE HERE
const evenNumbers = mixedNumbers.filter(function(num1) {
  return num1 % 2 === 0
})
...
// CODE HERE
const totalPopulation  = populations.reduce((runTotal, curVal) => runTotal + curVal)
...
// CODE HERE
const calcOrders = orders.map((arr) => {
   return taxedPrice = arr.price * (1 + arr.tax)
})

// console.log(calcOrders)
